  ...
  case ETAT_0 :
  	if (onEntry()) {
  	  //Actions en entrée de l état
    	  outputs()->CommandeMouvementXY_TETA_sym(0 , -7 , -1.57);
...
// _____________________________________
  ...
  case ETAT_1 :
  	if (onEntry()) {
  	  //Actions en entrée de l état
    	  outputs()->CommandeMouvementXY_TETA_sym(30 , -121 , 0);
  ...
  case ETAT_2 :
  	if (onEntry()) {
  	  //Actions en entrée de l état
    	  outputs()->CommandeMouvementXY_TETA_sym(110 , -121 , 1.57);
  ...
  case ETAT_3 :
  	if (onEntry()) {
  	  //Actions en entrée de l état
    	  outputs()->CommandeMouvementXY_TETA_sym(110 , -90 , -3.14);
  ...
  case ETAT_4 :
  	if (onEntry()) {
  	  //Actions en entrée de l état
    	  outputs()->CommandeMouvementXY_TETA_sym(53 , -90 , -3.14);
  ...
  case ETAT_5 :
  	if (onEntry()) {
  	  //Actions en entrée de l état
    	  outputs()->CommandeMouvementXY_TETA_sym(110 , -90 , 0);
  ...
  case ETAT_6 :
  	if (onEntry()) {
  	  //Actions en entrée de l état
    	  outputs()->CommandeMouvementXY_TETA_sym(165 , -90 , 0);
