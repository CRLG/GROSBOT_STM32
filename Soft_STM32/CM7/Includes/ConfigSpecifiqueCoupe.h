...
typedef enum {
    ...
    SERVO_THERESE_INTERMEDIAIRE_1  = 2300,
    SERVO_THERESE_INTERMEDIAIRE_2  = 2300,
    SERVO_THERESE_INTERMEDIAIRE_3  = 2300,
    SERVO_THERESE_INTERMEDIAIRE_4  = 2300,
    SERVO_THERESE_DEPLOYEE_1  = 2500,
    SERVO_THERESE_DEPLOYEE_2  = 2550,
    SERVO_THERESE_DEPLOYEE_3  = 2500,
    SERVO_THERESE_DEPLOYEE_4  = 2500,

    // SERVO PINCE NOISETTE
    SERVO_PINCE_NOISETTE_D_REPOS           = 480,
    SERVO_PINCE_NOISETTE_G_REPOS           = 2500,
    SERVO_PINCE_NOISETTE_D_FERMEE          = 800,
    SERVO_PINCE_NOISETTE_G_FERMEE          = 2150,
